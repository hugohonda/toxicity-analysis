...
($p<10^{-80}$ para a raz\~ao separada), (ii) sob replica\c c\~ao, a m\'edia
estratificada e a regress\~ao combinada empatam pelo menor erro quadr\'atico
m\'edio, e (iii) o ganho da regress\~ao sobre a m\'edia estratificada \'e
marginal sob o auxiliar adotado ($\rho_{xy} \approx 0{,}011$), indicando que
a escolha do auxiliar \'e cr\'itica. O \textit{pipeline} \'e integralmente reproduz\'ivel
